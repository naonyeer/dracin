    ...
    <main className="min-h-screen pt-16">
      <section className="container mx-auto px-4 pt-6 md:pt-8">
        <div className="editorial-panel overflow-hidden">
          <div className="grid gap-8 px-5 py-6 md:grid-cols-[minmax(0,1.5fr)_minmax(280px,0.9fr)] md:px-8 md:py-8">
            <div>
              <div className="section-kicker mb-4">
                <Sparkles className="h-3.5 w-3.5" />
                {activeCopy.eyebrow}
              </div>
              <h1 className="max-w-4xl text-4xl font-bold leading-none text-foreground md:text-6xl">
                {activeCopy.title}
              </h1>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {activeCopy.stats.map((stat) => (
                  <span key={stat} className="rounded-full border border-border/80 bg-background/50 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-foreground/90">
                    {stat}
                  </span>
                ))}
              </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3 md:grid-cols-1">
              <div className="rounded-[24px] border border-border/70 bg-background/55 p-4">
                ...
                <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Tentang</p>
              ...
              <div className="rounded-[24px] border border-border/70 bg-background/55 p-4">
                ...
                <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Sumber</p>
              ...
              <div className="rounded-[24px] border border-border/70 bg-background/55 p-4">
                ...
                <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Susunan</p>
      ...
      <div className="sticky top-16 z-40 mt-6 border-y border-border/50 bg-background/75 backdrop-blur-2xl">
